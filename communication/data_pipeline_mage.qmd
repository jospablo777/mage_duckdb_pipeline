...
There are some anotations to the imports, but now we will review the most complex part of our implementation, the loader function:
...
# -- snip --
    ...
    all_pulled_data = pl.concat(df_list, how="vertical") # <5> 

    return all_pulled_data # <6> 
```
1. aa
2. aa
3. aa 
