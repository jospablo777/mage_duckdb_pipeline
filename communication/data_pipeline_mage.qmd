...
[^6]: Little Mai and I 🐑.
[^7]: This occurs when the returned object is a data frame (Polars or Pandas). In this concrete case, that won't happen since we're returning a dictionary, but in the following blocks, it will be the case since the objects transferred will be Polars data frames. With dictionaries, serialization will still occur but in a [JSON format](https://github.com/mage-ai/mage-ai/issues/4725).
