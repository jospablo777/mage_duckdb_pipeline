...
First the forecaster is instantiated, then we train it with the `fit` function. With our learned model at hand, now we can move to the forecasting. So, let's forecast the rum sales:
