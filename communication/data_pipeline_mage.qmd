...
- [**Orange:**]{style="color:#FF8C00;"} the `LIMIT` clause of the SoQL query, used to limit the response to 2000 records.
...
Mage provides a variety of templates designed to guide you and save time. These templates were incredibly helpful when we[^6] first started building data pipelines. Next, we’ll modify the template to suit our specific use case. Overwrite the content of your newly created block with the following code, and let's proceed to analyze it:
